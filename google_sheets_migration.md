...
3. In the header row (Row 1), add these exact column names:
   ...
   - Payment Verified
   - Confirmation Sent
4. **Crucial:** Click the "Share" button in the top right.
...
I will handle this part for you. The code needs to be refactored to use the `gspread` library instead of `pandas`/`openpyxl`.
